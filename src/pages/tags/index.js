...
import { Main, Content, Title, List, ListItem, Opener, Option, TransitionContainer, SuperTitle, Window, Button } from '../../styled-components';
        ...
        {({ colours }) => {
          ...
          return <TransitionContainer>
            ...
            <div className="grid-doublecolumn">
              <Button
                onClick={() => this.handleSortClick('use')}
              >
                <Window
                  colour={sortBy === 'use' ? colour : 'white'}
                >
                  <Option>1, 2, 3</Option>
                </Window>
              </Button>
              ...
              >
                <Window
                  colour={sortBy === 'alphabet' ? colour : 'white'}
                >
                  <Option>A, B, C</Option>
                </Window>
              </Button>
